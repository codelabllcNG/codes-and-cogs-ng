    ...
    <div>
        ...
        <link rel="icon" href="/favicon.ico" />
          ...
          <div className=" text-center flex justify-center px-5 md:px-14">
            <p className="text-sm  w-[80%] text-pry-color">
                  Join our world class Remote Dev platform. Work In our world class facility, collaborate with some of the best developers and engineers around the world.
                <br /> <br />  Got what it takes?
            </p>
          </div>

          <div className="px-5 md:px-14 mt-5 justify-center flex decoration-blue-600 underline text-cyan-400 font-semibold "> <Link passHref href='#take-a-test'>
              <a> Take a test now!</a>
          </Link></div>
  </div>
          ...
          <div className="md:bg-[url('/images/sections-watermark.png')] bg-cover bg-right-bottom  bg-no-repeat">
          <div id='take-a-test' className='mb-5 mt-16 px-5 md:px-14 flex justify-center font-bold text-pry-color md:text-2xl'>
