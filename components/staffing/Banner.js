...
function Banner() {
  return (
      <div className="mt-10 rounded-xl bg-[url('/images/staffing-banner.webp')] bg-center bg-cover bg-no-repeat   text-white px-5 md:px-10 lg:px-16  py-5 md:py-10 lg:py-12">
          <div className='text-xs 320:text-base 350:text-2xl sm:text-2xl md:text-3xl' dangerouslySetInnerHTML={{ __html: "Ready to learn more and how we can help take your hiring process to the next level?"}}>
              {}
          </div>
